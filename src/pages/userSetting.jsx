...
import { GantiPassword } from "../redux/actions/AuthAction";
...
class UserSetting extends Component {
  ...
  render() {
    if (this.state.iniHome || this.props.userlog === false) {
      return <Redirect to="/" />;
    }
    return (
      <div>
        <div style={{ marginBottom: "220px" }} className="container pt-5">
