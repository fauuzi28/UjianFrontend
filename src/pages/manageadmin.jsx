        ...
        return products.map((val,index)=>{
            return (
                <tr key={index}>
                    ...
                    <td>{val.deskripsi}</td>
                    <td>
                        <button className='btn btn-primary' onClick={()=>this.onEditClick(index,val.id)}>Edit</button>
                    ...
                    <div>
                        <Modal isOpen={this.state.isModalAddOpen} toggle={this.toggleadd}>
                            ...
                            <ModalBody>
                                ...
                                <textarea cols="20" rows="10" ref='deskripsiadd' className='form-control mt-2' placeholder="deskripsi box "></textarea>
                            </ModalBody>
                            <ModalFooter>
                        ...
                        <Modal isOpen={this.state.isModalEditOpen} toggle={this.toggleedit}>
                            ...
                            <ModalBody>
                                ...
                                <input type="number" ref='stockedit' defaultValue={products[indexedit].stock} placeholder="Jumlah Stock" className="form-control mt-2"/>
                                ...
                                <textarea cols="20" rows="10" ref='deskripsiedit'defaultValue={products[indexedit].deskripsi} className='form-control mt-2' placeholder="deskripsi box "></textarea>
                            </ModalBody>
                            <ModalFooter>
